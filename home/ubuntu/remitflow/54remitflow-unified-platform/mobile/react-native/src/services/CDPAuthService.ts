...
// --- Configuration ---
const API_BASE_URL = 'https://api.nigerianremittance.com/cdp/v1';
...
async function handleLogin() {
  // 1. Send OTP
  const sendResult = await cdpAuthService.sendOtp('user@example.com');
  ...
  const verifyResult = await cdpAuthService.verifyOtp('user@example.com', '123456');
