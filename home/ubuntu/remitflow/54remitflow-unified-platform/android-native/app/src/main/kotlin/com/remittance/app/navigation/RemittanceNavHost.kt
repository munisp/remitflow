package com.remittance.app.navigation
...
import com.remittance.app.ui.screens.*
import com.remittance.features.enhanced.*
...
fun RemittanceNavHost(
    ...
    NavHost(
        ...
        composable("rate_calculator") { RateCalculatorScreen(navController) }
        composable("beneficiaries") { BeneficiariesScreen(navController) }
        composable("payment_methods") { PaymentMethodsScreen(navController) }
        composable("help") { HelpScreen(navController) }
        composable("transaction_history") { TransactionHistoryScreen(navController) }
        composable("transaction_details/{id}") { backStackEntry ->
            TransactionDetailsScreen(navController, backStackEntry.arguments?.getString("id"))
        }
        composable("security") { SecurityScreen(navController) }
        composable("notifications") { NotificationsScreen(navController) }
        composable("beneficiary_management") { BeneficiaryManagementScreen(navController) }
        composable("biometric_auth") { BiometricAuthScreen(navController) }
        composable("document_upload") { DocumentUploadScreen(navController) }
        composable("property_kyc") { PropertyKYCScreen(navController) }
        composable("multichannel_payment") { MultiChannelPaymentScreen(navController) }
        composable("account_health") { AccountHealthDashboardScreen(navController) }
        composable("rate_limiting") { RateLimitingInfoScreen(navController) }
        composable("mpesa") { MPesaIntegrationScreen(navController) }
        composable("wise") { WiseInternationalTransferScreen(navController) }
    }
}
