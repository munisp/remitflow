"""
End-to-end test for RegisterUser
...
class TestRegisterUserE2E:
    ...
    @pytest.mark.asyncio
    async def test_register_user_complete_flow(self, browser_page: Page, test_user_data):
        ...
        await page.wait_for_selector('[data-testid="registration-form"]')
        ...
        await page.wait_for_selector('[data-testid="verification-screen"]')
    ...
    @pytest.mark.asyncio
    async def test_register_user_error_handling(self, browser_page: Page, test_user_data):
        """Test error handling in user registration and onboarding."""
        page = browser_page
    ...
    @pytest.mark.asyncio
    async def test_register_user_mobile_responsive(self, test_user_data):
        """Test user registration and onboarding on mobile viewport."""
        async with async_playwright() as p:
            browser = await p.chromium.launch(headless=True)
            context = await browser.new_context(
    ...
    @pytest.mark.asyncio
    async def test_register_user_accessibility(self, browser_page: Page, test_user_data):
        """Test accessibility of user registration and onboarding."""
        page = browser_page
    ...
    @pytest.mark.asyncio
    async def test_register_user_performance(self, browser_page: Page, test_user_data):
        """Test performance of user registration and onboarding."""
        page = browser_page
