...
@pytest.mark.e2e
class TestSendMoneyE2E:
    """End-to-end tests for sending money to beneficiary."""
    ...
    @pytest.mark.asyncio
    async def test_send_money_complete_flow(self, browser_page: Page, test_user_data):
        """Test complete sending money to beneficiary journey."""
        page = browser_page
        ...
        await page.wait_for_selector('[data-testid="send-money-form"]')
        ...
        await page.wait_for_selector('[data-testid="confirmation-screen"]')
    ...
    @pytest.mark.asyncio
    async def test_send_money_error_handling(self, browser_page: Page, test_user_data):
        """Test error handling in sending money to beneficiary."""
        page = browser_page
    ...
    @pytest.mark.asyncio
    async def test_send_money_mobile_responsive(self, test_user_data):
        """Test sending money to beneficiary on mobile viewport."""
        async with async_playwright() as p:
            browser = await p.chromium.launch(headless=True)
            context = await browser.new_context(
    ...
    @pytest.mark.asyncio
    async def test_send_money_accessibility(self, browser_page: Page, test_user_data):
        """Test accessibility of sending money to beneficiary."""
        page = browser_page
    ...
    @pytest.mark.asyncio
    async def test_send_money_performance(self, browser_page: Page, test_user_data):
        """Test performance of sending money to beneficiary."""
        page = browser_page
