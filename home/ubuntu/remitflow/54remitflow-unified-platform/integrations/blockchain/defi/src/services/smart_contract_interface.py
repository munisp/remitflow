...
class ContractInteractionError(Exception):
    ...
    def __init__(self, message: str, contract_address: str = None, transaction_hash: str = None):
...
class SmartContractInterface:
    ...
    def __init__(self, chain_name: str, contract_address: str, contract_abi: List[Dict[str, Any]], connector_manager: BlockchainConnectorManager):
