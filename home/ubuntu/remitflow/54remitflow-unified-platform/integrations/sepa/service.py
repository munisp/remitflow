...
class TransactionAlreadyExistsError(ServiceException):
    ...
    def __init__(self, end_to_end_id: str):
...
class InvalidTransactionStateError(ServiceException):
    ...
    def __init__(self, transaction_id: uuid.UUID, current_status: TransactionStatus, action: str):
...
class SCTInstService:
    ...
    def delete_transaction(self, transaction_id: uuid.UUID):
        """
