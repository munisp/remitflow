...
struct QuickActionsView: View {
    ...
    func destinationView(for action: String) -> some View {
        ...
        case "TransactionDetails":
            TransactionDetailsView(transactionId: "").environmentObject(AuthManager()).environmentObject(NetworkManager())
        case "DocumentUpload":
            DocumentUploadView()
        case "Register":
            RegisterView()
        case "BiometricAuth":
            BiometricAuthView()
        case "MPesa":
            MPesaIntegrationView()
        case "PaymentPerformance":
            PaymentPerformanceView()
        case "Wise":
            WiseInternationalTransferView()
        case "Support":
            SupportView()
        case "Notifications":
            NotificationsView()
        case "Onboarding":
            OnboardingView()
        case "VirtualCardManagement":
            VirtualCardManagementView()
        case "Help":
            HelpView()
        case "Security":
            SecurityView()
        ...
        case "RateLimiting":
            RateLimitingInfoView()
        case "VirtualAccount":
            EnhancedVirtualAccountView()
        default:
            EmptyView()
        }
    }
