"""
Remitly Payment Gateway Implementation
...
class RemitlyGateway(BasePaymentGateway):
    """
    Remitly payment gateway - Remitly International Money Transfer
    ...
    def _get_base_url(self) -> str:
        ...
        urls = {
            "production": f"https://api.remitly.com/v2",
            "sandbox": f"https://sandbox-api.remitly.com/v2"
        }
