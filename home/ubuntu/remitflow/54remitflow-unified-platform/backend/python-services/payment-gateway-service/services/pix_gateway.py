"""
PIX Payment Gateway Implementation
...
class PIXGateway(BasePaymentGateway):
    """
    PIX payment gateway implementation
    Handles payments through Brazilian Instant Payment System
    """
    ...
    def _get_base_url(self) -> str:
        ...
        if self.environment == "production":
            return f"https://api.pix.com/v1"
        return f"https://sandbox-api.pix.com/v1"
