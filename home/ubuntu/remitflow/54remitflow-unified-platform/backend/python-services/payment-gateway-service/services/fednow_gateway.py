"""
FedNow Payment Gateway Implementation
...
class FedNowGateway(BasePaymentGateway):
    """
    FedNow payment gateway implementation
    Handles payments through Federal Reserve Instant Payment Service
    """
    ...
    def _get_base_url(self) -> str:
        ...
        if self.environment == "production":
            return f"https://api.fednow.com/v1"
        return f"https://sandbox-api.fednow.com/v1"
