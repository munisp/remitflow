"""
SEPA Payment Gateway Implementation
...
class SEPAGateway(BasePaymentGateway):
    """
    SEPA payment gateway implementation
    Handles payments through Single Euro Payments Area
    """
    ...
    def _get_base_url(self) -> str:
        ...
        if self.environment == "production":
            return f"https://api.sepa.com/v1"
        return f"https://sandbox-api.sepa.com/v1"
