"""
CIPS Payment Gateway Implementation
...
class CIPSGateway(BasePaymentGateway):
    """
    CIPS payment gateway implementation
    Handles payments through Cross-Border Interbank Payment System (China)
    """
    ...
    def _get_base_url(self) -> str:
        ...
        if self.environment == "production":
            return f"https://api.cips.com/v1"
        return f"https://sandbox-api.cips.com/v1"
