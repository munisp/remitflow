"""
Wise Payment Gateway Implementation
Wise (TransferWise) Multi-Currency Platform
"""
...
class WiseGateway(BasePaymentGateway):
    """
    Wise payment gateway - Wise (TransferWise) Multi-Currency Platform
    ...
    def _get_base_url(self) -> str:
        ...
        urls = {
            "production": f"https://api.wise.com/v2",
            "sandbox": f"https://sandbox-api.wise.com/v2"
        }
