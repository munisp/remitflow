"""
SWIFT Payment Gateway Implementation
...
class SWIFTGateway(BasePaymentGateway):
    """
    SWIFT payment gateway implementation
    Handles payments through Society for Worldwide Interbank Financial Telecommunication
    """
    ...
    def _get_base_url(self) -> str:
        ...
        if self.environment == "production":
            return f"https://api.swift.com/v1"
        return f"https://sandbox-api.swift.com/v1"
