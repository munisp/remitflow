"""
FastAPI Router for Pep Screening Service
...
from .pep_screening_service import PEPScreeningService

# Initialize router
router = APIRouter(
    prefix="/api/v1/pep-screening",
    tags=["Pep Screening"]
)
...
async def health_check():
    ...
    try:
        return BaseResponse(
            success=True,
            message="Pep Screening service is healthy"
        )
