...
Voice AI conversational commerce

## Features

- ✅ Send messages via Voice Ai
- ✅ Receive webhooks from Voice Ai
- ✅ Order management
- ✅ Message tracking
...
```bash
export VOICE_AI_API_KEY="your_api_key"
export VOICE_AI_API_SECRET="your_api_secret"
export VOICE_AI_WEBHOOK_SECRET="your_webhook_secret"
export PORT=8090
```
...
```bash
curl -X POST http://localhost:8090/api/v1/order \
  -H "Content-Type: application/json" \
  -d '{
    "customer_id": "CUST123",
