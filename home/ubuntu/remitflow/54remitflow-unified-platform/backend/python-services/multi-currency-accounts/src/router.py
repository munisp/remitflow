"""
FastAPI Router for Multi Currency Service
...
from .multi_currency_service import MultiCurrencyAccountService

# Initialize router
router = APIRouter(
    prefix="/api/v1/multi-currency",
    tags=["Multi Currency"]
)
...
# Initialize service
service = MultiCurrencyAccountService()
...
async def health_check():
    ...
    try:
        return BaseResponse(
            success=True,
            message="Multi Currency service is healthy"
        )
