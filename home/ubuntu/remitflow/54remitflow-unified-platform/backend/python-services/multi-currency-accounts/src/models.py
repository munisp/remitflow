"""Database Models for Multi Currency"""
...
class MultiCurrencyTransaction(Base):
    ...
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    multi_currency_id = Column(String(36), ForeignKey("multi_currency.id"), nullable=False)
    ...
    def to_dict(self):
        return {
            "id": self.id,
            "multi_currency_id": self.multi_currency_id,
