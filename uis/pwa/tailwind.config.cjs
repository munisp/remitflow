...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      animation: {
        "fade-in": "fadeIn 0.3s ease-out", "slide-up": "slideUp 0.4s ease-out", "slide-down": "slideDown 0.3s ease-out",
        "scale-in": "scaleIn 0.2s ease-out", shimmer: "shimmer 2s infinite linear", "pulse-soft": "pulseSoft 2s infinite", "bounce-soft": "bounceSoft 0.5s ease-out",
      },
      keyframes: {
      ...
      transitionTimingFunction: { "bounce-in": "cubic-bezier(0.68, -0.55, 0.265, 1.55)" },
      backdropBlur: { xs: "2px" },
    },
  },
  plugins: [],
