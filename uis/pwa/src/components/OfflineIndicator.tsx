...
export const OfflineIndicator: React.FC = () => {
  ...
  // Don't show anything if online and no pending items and connection is fine
  if (isOnline && pendingCount === 0 && !showBanner && !isSlowConnection) {
    return null;
  }
  ...
  return (
    <>
      ...
      {isOnline && isSlowConnection && !showBanner && (
        <div className="fixed top-0 left-0 right-0 z-50 px-4 py-2 text-center text-sm font-medium bg-amber-500 text-amber-950">
