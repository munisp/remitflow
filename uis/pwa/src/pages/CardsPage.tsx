...
import { cardService, CardStatus, CardType, type Card } from "../services/api";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => alert("Issue Card feature coming soon!")}
          className="px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-xl font-semibold hover:from-indigo-700 hover:to-violet-700 transition-all flex items-center gap-2"
        >
          <svg
            className="w-5 h-5"
            fill="none"
