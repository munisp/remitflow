...
export default function ImmigrantWorkerSendScreen() {
      ...
      >
        {isLoading ? (
          ...
          <View style={styles.errorContainer}>
            <Text style={styles.errorText}>Failed to load Transfer History.</Text>
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>{search ? 'No results found.' : 'No Transfer History yet.'}</Text>
          </View>
        ) : (
