...
export default function EducationPaymentsScreen() {
  ...
  const { data, isLoading, error, refetch } = trpc.educationPayments.listPayments.useQuery(undefined, {
    retry: 2,
    staleTime: 30_000,
  });
      ...
      >
        {isLoading ? (
          ...
          <View style={styles.errorContainer}>
            <Text style={styles.errorText}>Failed to load Education Payments.</Text>
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>{search ? 'No results found.' : 'No Education Payments yet.'}</Text>
          </View>
        ) : (
