...
export default function MedicalTourismScreen() {
  ...
  const { data, isLoading, error, refetch } = trpc.medicalTourism.listProviders.useQuery(undefined, {
    retry: 2,
    staleTime: 30_000,
  });
      ...
      >
        {isLoading ? (
          ...
          <View style={styles.errorContainer}>
            <Text style={styles.errorText}>Failed to load Medical Providers.</Text>
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>{search ? 'No results found.' : 'No Medical Providers yet.'}</Text>
          </View>
        ) : (
