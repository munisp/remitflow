...
export default function AdminInviteCodesScreen() {
  ...
  const { data, isLoading, refetch } = (trpc as any)?.['admin']?.['getInviteCodes']?.useQuery?.() ?? { data: null, isLoading: false, refetch: () => {} };
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Admin Invite Codes</Text>
