...
const pwaPlugin = VitePWA({
  ...
  manifest: {
    ...
    icons: [
      {
        src: "/manus-storage/icon-192_d0405887.png",
        sizes: "192x192",
        type: "image/png",
        purpose: "any",
      },
      {
        src: "/manus-storage/icon-512_41fa5aeb.png",
        sizes: "512x512",
        type: "image/png",
        purpose: "any",
      },
      {
        src: "/manus-storage/icon-maskable-512_3fbf000b.png",
        sizes: "512x512",
        type: "image/png",
        purpose: "maskable",
      },
      {
        src: "/manus-storage/apple-touch-icon_28be41f0.png",
        sizes: "180x180",
        type: "image/png",
        purpose: "any",
      },
    ...
    shortcuts: [
      {
        ...
        url: "/send-money",
        icons: [{ src: "/manus-storage/icon-192_d0405887.png", sizes: "192x192" }],
      },
      {
        name: "Invest",
        short_name: "Invest",
...
console.log('[vite.config] NODE_ENV:', process.env.NODE_ENV, '| isDev:', isDev, '| jsxLocPlugin included:', !isDev);
const plugins = [
  react(),
  ...(isDev ? [] : [jsxLocPlugin()]),
  tailwindcss(),
