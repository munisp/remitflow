...
class TransferTrackingScreen extends ConsumerStatefulWidget {
  const TransferTrackingScreen({super.key});
  @override
  ConsumerState<TransferTrackingScreen> createState() => _TransferTrackingScreenState();
}
...
class _TransferTrackingScreenState extends ConsumerState<TransferTrackingScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('transfers.track');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Transfer Tracking', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
