...
class ComplianceScoringPageScreen extends ConsumerStatefulWidget {
  const ComplianceScoringPageScreen({super.key});
  @override
  ConsumerState<ComplianceScoringPageScreen> createState() => _ComplianceScoringPageScreenState();
}

class _ComplianceScoringPageScreenState extends ConsumerState<ComplianceScoringPageScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/complianceScoring.list');
              ...
              : _items.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.score, color: const Color(0xFFEF4444), size: 64),
                          const SizedBox(height: 16),
                          const Text(
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              ...
                              child: Icon(Icons.score, color: const Color(0xFFEF4444), size: 20),
                            ),
                            title: Text(
