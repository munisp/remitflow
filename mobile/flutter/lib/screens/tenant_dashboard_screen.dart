...
class _TenantDashboardScreenState extends ConsumerState<TenantDashboardScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('tenants.getDashboard');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Tenant Dashboard', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
