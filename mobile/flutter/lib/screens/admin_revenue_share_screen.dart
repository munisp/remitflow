...
class AdminRevenueShareScreen extends ConsumerStatefulWidget {
  const AdminRevenueShareScreen({super.key});
  @override
  ConsumerState<AdminRevenueShareScreen> createState() => _AdminRevenueShareScreenState();
}

class _AdminRevenueShareScreenState extends ConsumerState<AdminRevenueShareScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('admin.getRevenueShare');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Admin Revenue Share', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
