...
class SendToNigeriaScreen extends ConsumerStatefulWidget {
  const SendToNigeriaScreen({super.key});
  @override
  ConsumerState<SendToNigeriaScreen> createState() => _SendToNigeriaScreenState();
}

class _SendToNigeriaScreenState extends ConsumerState<SendToNigeriaScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Send to Nigeria', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
