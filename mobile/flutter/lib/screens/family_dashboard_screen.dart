...
class _FamilyDashboardScreenState extends ConsumerState<FamilyDashboardScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('family.getDashboard');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Family Dashboard', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
