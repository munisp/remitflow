...
class FeeRulesEngineScreen extends ConsumerStatefulWidget {
  const FeeRulesEngineScreen({super.key});
  @override
  ConsumerState<FeeRulesEngineScreen> createState() => _FeeRulesEngineScreenState();
}

class _FeeRulesEngineScreenState extends ConsumerState<FeeRulesEngineScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Fee Rules Engine', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
