...
class MojaloopScreen extends ConsumerStatefulWidget {
  const MojaloopScreen({super.key});
  @override
  ConsumerState<MojaloopScreen> createState() => _MojaloopScreenState();
}

class _MojaloopScreenState extends ConsumerState<MojaloopScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('payments.getMojaloop');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Mojaloop', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
