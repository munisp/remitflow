...
class _AdminBulkActionsScreenState extends ConsumerState<AdminBulkActionsScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('admin.getBulkActions');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Admin Bulk Actions', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
