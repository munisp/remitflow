...
class SendToTanzaniaScreen extends ConsumerStatefulWidget {
  const SendToTanzaniaScreen({super.key});
  @override
  ConsumerState<SendToTanzaniaScreen> createState() => _SendToTanzaniaScreenState();
}

class _SendToTanzaniaScreenState extends ConsumerState<SendToTanzaniaScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Send to Tanzania', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
