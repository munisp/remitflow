...
class CocoIndexPageScreen extends ConsumerStatefulWidget {
  const CocoIndexPageScreen({super.key});
  @override
  ConsumerState<CocoIndexPageScreen> createState() => _CocoIndexPageScreenState();
}

class _CocoIndexPageScreenState extends ConsumerState<CocoIndexPageScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/cocoIndex.list');
