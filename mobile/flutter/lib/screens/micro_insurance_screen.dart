...
class _MicroInsuranceScreenState extends State<MicroInsuranceScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final result = await api.get('/micro-insurance');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Micro-Insurance'), elevation: 0),
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('Micro-Insurance', style: Theme.of(context).textTheme.headlineSmall),
