...
class ReconciliationV2PageScreen extends ConsumerStatefulWidget {
  const ReconciliationV2PageScreen({super.key});
  @override
  ConsumerState<ReconciliationV2PageScreen> createState() => _ReconciliationV2PageScreenState();
}

class _ReconciliationV2PageScreenState extends ConsumerState<ReconciliationV2PageScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/reconciliation.list');
              ...
              : _items.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.balance, color: const Color(0xFF6C63FF), size: 64),
                          const SizedBox(height: 16),
                          const Text(
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              ...
                              child: Icon(Icons.balance, color: const Color(0xFF6C63FF), size: 20),
                            ),
                            title: Text(
