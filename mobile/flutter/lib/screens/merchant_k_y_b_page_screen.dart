...
class MerchantKYBPageScreen extends ConsumerStatefulWidget {
  const MerchantKYBPageScreen({super.key});
  @override
  ConsumerState<MerchantKYBPageScreen> createState() => _MerchantKYBPageScreenState();
}

class _MerchantKYBPageScreenState extends ConsumerState<MerchantKYBPageScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/merchantKyb.list');
              ...
              : _items.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.store, color: const Color(0xFF6C63FF), size: 64),
                          const SizedBox(height: 16),
                          const Text(
                            'No Merchant KYB data yet',
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              ...
                              child: Icon(Icons.store, color: const Color(0xFF6C63FF), size: 20),
                            ),
                            title: Text(
