...
class _SmeDashboardScreenState extends State<SmeDashboardScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final result = await api.get('/sme-dashboard');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('SME Dashboard'), elevation: 0),
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('SME Dashboard', style: Theme.of(context).textTheme.headlineSmall),
