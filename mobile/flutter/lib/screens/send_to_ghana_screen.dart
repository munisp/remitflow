...
class SendToGhanaScreen extends ConsumerStatefulWidget {
  const SendToGhanaScreen({super.key});
  @override
  ConsumerState<SendToGhanaScreen> createState() => _SendToGhanaScreenState();
}

class _SendToGhanaScreenState extends ConsumerState<SendToGhanaScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Send to Ghana', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
