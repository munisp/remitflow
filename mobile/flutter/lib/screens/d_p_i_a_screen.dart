...
class DPIAScreen extends ConsumerStatefulWidget {
  const DPIAScreen({super.key});
  @override
  ConsumerState<DPIAScreen> createState() => _DPIAScreenState();
}

class _DPIAScreenState extends ConsumerState<DPIAScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/dpia.list');
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          const Text(
                            'No Data Privacy Impact Assessment data yet',
