...
class TransactionExportScreen extends ConsumerStatefulWidget {
  const TransactionExportScreen({super.key});
  @override
  ConsumerState<TransactionExportScreen> createState() => _TransactionExportScreenState();
}

class _TransactionExportScreenState extends ConsumerState<TransactionExportScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Transaction Export', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
