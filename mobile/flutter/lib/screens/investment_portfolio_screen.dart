...
class InvestmentPortfolioScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<InvestmentPortfolioScreen> createState() => _InvestmentPortfolioScreenState();
}
...
class _InvestmentPortfolioScreenState extends ConsumerState<InvestmentPortfolioScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('investments.getPortfolio');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Investment Portfolio', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
