...
class FXHedgingScreen extends ConsumerStatefulWidget {
  const FXHedgingScreen({super.key});
  @override
  ConsumerState<FXHedgingScreen> createState() => _FXHedgingScreenState();
}

class _FXHedgingScreenState extends ConsumerState<FXHedgingScreen> {
