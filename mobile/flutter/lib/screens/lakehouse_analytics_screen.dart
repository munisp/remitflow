...
class LakehouseAnalyticsScreen extends ConsumerStatefulWidget {
  const LakehouseAnalyticsScreen({super.key});
  @override
  ConsumerState<LakehouseAnalyticsScreen> createState() => _LakehouseAnalyticsScreenState();
}

class _LakehouseAnalyticsScreenState extends ConsumerState<LakehouseAnalyticsScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('analytics.getLakehouse');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Lakehouse Analytics', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
