...
class SendToKenyaScreen extends ConsumerStatefulWidget {
  const SendToKenyaScreen({super.key});
  @override
  ConsumerState<SendToKenyaScreen> createState() => _SendToKenyaScreenState();
}

class _SendToKenyaScreenState extends ConsumerState<SendToKenyaScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Send to Kenya', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
