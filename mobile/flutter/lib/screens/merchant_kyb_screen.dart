...
class MerchantKYBScreen extends ConsumerStatefulWidget {
  const MerchantKYBScreen({super.key});
  @override
  ConsumerState<MerchantKYBScreen> createState() => _MerchantKYBScreenState();
}

class _MerchantKYBScreenState extends ConsumerState<MerchantKYBScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('kyc.getMerchantKYB');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Merchant KYB', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
