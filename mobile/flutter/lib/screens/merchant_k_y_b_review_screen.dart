  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Merchant KYB Review', style: TextStyle(color: Color(0xFFE2E8F0), fontWeight: FontWeight.w700)),
      ...
      body: _isLoading
          ...
          : _error != null
              ...
              : _items.isEmpty
                  ? const Center(child: Text('No KYB applications found', style: TextStyle(color: Color(0xFF94A3B8))))
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            title: Text(item['merchantName']?.toString() ?? item['businessName']?.toString() ?? 'KYB Application ${index + 1}',
                                style: const TextStyle(color: Color(0xFFE2E8F0), fontWeight: FontWeight.w600)),
                            subtitle: Text(item['status']?.toString() ?? item['submissionDate']?.toString() ?? '',
