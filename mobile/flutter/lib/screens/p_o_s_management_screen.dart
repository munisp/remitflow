...
class POSManagementScreen extends ConsumerStatefulWidget {
  const POSManagementScreen({super.key});
  @override
  ConsumerState<POSManagementScreen> createState() => _POSManagementScreenState();
}
class _POSManagementScreenState extends ConsumerState<POSManagementScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/posManagement.list');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('POS Management', style: TextStyle(color: Color(0xFFE2E8F0), fontWeight: FontWeight.w700)),
