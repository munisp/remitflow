...
class _ConsentManagementScreenState extends ConsumerState<ConsentManagementScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('privacy.getConsents');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Consent Management', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
