...
class _OllamaChatScreenState extends State<OllamaChatScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final data = await apiService.query('ai.listConversations');
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Ollama Chat', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
      ...
      body: _loading
          ...
          : _error != null
              ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('Failed to load Ollama Chat', style: const TextStyle(color: Color(0xFFEF4444))),
                  const SizedBox(height: 12),
              ...
              : _filtered.isEmpty
                  ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      const SizedBox(height: 12),
                      Text(_search.isNotEmpty ? 'No results found.' : 'No Ollama Chat yet.',
