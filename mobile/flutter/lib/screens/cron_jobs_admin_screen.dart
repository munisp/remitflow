...
class CronJobsAdminScreen extends ConsumerStatefulWidget {
  const CronJobsAdminScreen({super.key});
  @override
  ConsumerState<CronJobsAdminScreen> createState() => _CronJobsAdminScreenState();
}

class _CronJobsAdminScreenState extends ConsumerState<CronJobsAdminScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('admin.getCronJobs');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Cron Jobs Admin', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
