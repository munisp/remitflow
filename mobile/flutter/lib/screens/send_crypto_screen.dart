...
class _SendCryptoScreenState extends State<SendCryptoScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final data = await apiService.query('stablecoin.getWallet');
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Send Crypto', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
      ...
      body: _loading
          ...
          : _error != null
              ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('Failed to load Send Crypto', style: const TextStyle(color: Color(0xFFEF4444))),
                  const SizedBox(height: 12),
