...
class ARTAgentPageScreen extends ConsumerStatefulWidget {
  const ARTAgentPageScreen({super.key});
  @override
  ConsumerState<ARTAgentPageScreen> createState() => _ARTAgentPageScreenState();
}

class _ARTAgentPageScreenState extends ConsumerState<ARTAgentPageScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/artAgent.list');
              ...
              : _items.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.smart_toy, color: const Color(0xFF6C63FF), size: 64),
                          const SizedBox(height: 16),
                          const Text(
                            'No ART Agent data yet',
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              ...
                              child: Icon(Icons.smart_toy, color: const Color(0xFF6C63FF), size: 20),
                            ),
                            title: Text(
