...
class PWADashboardScreen extends ConsumerStatefulWidget {
  const PWADashboardScreen({super.key});
  @override
  ConsumerState<PWADashboardScreen> createState() => _PWADashboardScreenState();
}

class _PWADashboardScreenState extends ConsumerState<PWADashboardScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/pwaDashboard.list');
              ...
              : _items.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.dashboard, color: const Color(0xFF6C63FF), size: 64),
                          const SizedBox(height: 16),
                          const Text(
                            'No PWA Dashboard data yet',
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              ...
                              child: Icon(Icons.dashboard, color: const Color(0xFF6C63FF), size: 20),
                            ),
                            title: Text(
