...
class FeeRulesCRUDScreen extends ConsumerStatefulWidget {
  const FeeRulesCRUDScreen({super.key});
  @override
  ConsumerState<FeeRulesCRUDScreen> createState() => _FeeRulesCRUDScreenState();
}

class _FeeRulesCRUDScreenState extends ConsumerState<FeeRulesCRUDScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Fee Rules CRUD', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
