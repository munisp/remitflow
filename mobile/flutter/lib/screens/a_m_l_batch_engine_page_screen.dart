...
class AMLBatchEnginePageScreen extends ConsumerStatefulWidget {
  const AMLBatchEnginePageScreen({super.key});
  @override
  ConsumerState<AMLBatchEnginePageScreen> createState() => _AMLBatchEnginePageScreenState();
}

class _AMLBatchEnginePageScreenState extends ConsumerState<AMLBatchEnginePageScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/amlBatch.list');
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            title: Text(
                              item['batchId']?.toString() ?? item['name']?.toString() ?? 'Item ${index + 1}',
