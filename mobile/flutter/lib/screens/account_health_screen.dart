...
class AccountHealthScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AccountHealthScreen> createState() => _AccountHealthScreenState();
}
...
class _AccountHealthScreenState extends ConsumerState<AccountHealthScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('account.getHealth');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Account Health', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
