...
class LoyaltyRewardsV2PageScreen extends ConsumerStatefulWidget {
  const LoyaltyRewardsV2PageScreen({super.key});
  @override
  ConsumerState<LoyaltyRewardsV2PageScreen> createState() => _LoyaltyRewardsV2PageScreenState();
}

class _LoyaltyRewardsV2PageScreenState extends ConsumerState<LoyaltyRewardsV2PageScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/loyaltyRewards.list');
              ...
              : _items.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.stars, color: const Color(0xFFF59E0B), size: 64),
                          const SizedBox(height: 16),
                          const Text(
                            'No Loyalty Rewards data yet',
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              ...
                              child: Icon(Icons.stars, color: const Color(0xFFF59E0B), size: 20),
                            ),
                            title: Text(
