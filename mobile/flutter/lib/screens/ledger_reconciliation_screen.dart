...
class LedgerReconciliationScreen extends ConsumerStatefulWidget {
  const LedgerReconciliationScreen({super.key});
  @override
  ConsumerState<LedgerReconciliationScreen> createState() => _LedgerReconciliationScreenState();
}

class _LedgerReconciliationScreenState extends ConsumerState<LedgerReconciliationScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Ledger Reconciliation', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
