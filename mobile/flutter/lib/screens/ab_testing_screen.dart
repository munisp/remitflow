...
class _AbTestingScreenState extends State<AbTestingScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final result = await api.get('/ab-testing');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('A/B Testing'), elevation: 0),
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('A/B Testing', style: Theme.of(context).textTheme.headlineSmall),
