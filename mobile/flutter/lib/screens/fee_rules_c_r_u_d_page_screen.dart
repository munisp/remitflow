...
class FeeRulesCRUDPageScreen extends ConsumerStatefulWidget {
  const FeeRulesCRUDPageScreen({super.key});
  @override
  ConsumerState<FeeRulesCRUDPageScreen> createState() => _FeeRulesCRUDPageScreenState();
}

class _FeeRulesCRUDPageScreenState extends ConsumerState<FeeRulesCRUDPageScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/feeRules.list');
