...
class ComplianceWatchlistScreen extends ConsumerStatefulWidget {
  const ComplianceWatchlistScreen({super.key});
  @override
  ConsumerState<ComplianceWatchlistScreen> createState() => _ComplianceWatchlistScreenState();
}

class _ComplianceWatchlistScreenState extends ConsumerState<ComplianceWatchlistScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('compliance.getWatchlist');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Compliance Watchlist', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
