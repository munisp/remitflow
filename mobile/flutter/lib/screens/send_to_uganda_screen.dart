...
class SendToUgandaScreen extends ConsumerStatefulWidget {
  const SendToUgandaScreen({super.key});
  @override
  ConsumerState<SendToUgandaScreen> createState() => _SendToUgandaScreenState();
}

class _SendToUgandaScreenState extends ConsumerState<SendToUgandaScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Send to Uganda', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
