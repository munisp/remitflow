...
class FeatureFlagsAdminScreen extends ConsumerStatefulWidget {
  const FeatureFlagsAdminScreen({super.key});
  @override
  ConsumerState<FeatureFlagsAdminScreen> createState() => _FeatureFlagsAdminScreenState();
}

class _FeatureFlagsAdminScreenState extends ConsumerState<FeatureFlagsAdminScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('admin.getFeatureFlags');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Feature Flags Admin', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
