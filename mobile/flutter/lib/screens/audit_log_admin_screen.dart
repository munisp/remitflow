...
class AuditLogAdminScreen extends ConsumerStatefulWidget {
  const AuditLogAdminScreen({super.key});
  @override
  ConsumerState<AuditLogAdminScreen> createState() => _AuditLogAdminScreenState();
}

class _AuditLogAdminScreenState extends ConsumerState<AuditLogAdminScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('audit.getLogs');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Audit Log Admin', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
