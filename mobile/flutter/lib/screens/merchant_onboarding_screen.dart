...
class MerchantOnboardingScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MerchantOnboardingScreen> createState() => _MerchantOnboardingScreenState();
}

class _MerchantOnboardingScreenState extends ConsumerState<MerchantOnboardingScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('kyc.getMerchantOnboarding');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Merchant Onboarding', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
