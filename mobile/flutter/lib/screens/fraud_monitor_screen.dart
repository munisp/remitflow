...
class FraudMonitorScreen extends ConsumerStatefulWidget {
  const FraudMonitorScreen({super.key});
  @override
  ConsumerState<FraudMonitorScreen> createState() => _FraudMonitorScreenState();
}

class _FraudMonitorScreenState extends ConsumerState<FraudMonitorScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Fraud Monitor', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
