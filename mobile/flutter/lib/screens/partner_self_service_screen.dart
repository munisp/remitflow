...
class PartnerSelfServiceScreen extends ConsumerStatefulWidget {
  const PartnerSelfServiceScreen({super.key});
  @override
  ConsumerState<PartnerSelfServiceScreen> createState() => _PartnerSelfServiceScreenState();
}

class _PartnerSelfServiceScreenState extends ConsumerState<PartnerSelfServiceScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('partner.getSelfService');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Partner Self Service', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
