...
class SendToSouthAfricaScreen extends ConsumerStatefulWidget {
  const SendToSouthAfricaScreen({super.key});
  @override
  ConsumerState<SendToSouthAfricaScreen> createState() => _SendToSouthAfricaScreenState();
}

class _SendToSouthAfricaScreenState extends ConsumerState<SendToSouthAfricaScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Send to South Africa', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
