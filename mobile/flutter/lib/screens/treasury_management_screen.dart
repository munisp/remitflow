...
class _TreasuryManagementScreenState extends ConsumerState<TreasuryManagementScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('treasury.getPositions');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Treasury Management', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
