...
class TenantFeatureFlagsAdminScreen extends ConsumerStatefulWidget {
  const TenantFeatureFlagsAdminScreen({super.key});
  @override
  ConsumerState<TenantFeatureFlagsAdminScreen> createState() => _TenantFeatureFlagsAdminScreenState();
}

class _TenantFeatureFlagsAdminScreenState extends ConsumerState<TenantFeatureFlagsAdminScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('admin.getTenantFeatureFlags');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Tenant Feature Flags Admin', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
