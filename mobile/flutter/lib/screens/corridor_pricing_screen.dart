...
class CorridorPricingScreen extends ConsumerStatefulWidget {
  const CorridorPricingScreen({super.key});
  @override
  ConsumerState<CorridorPricingScreen> createState() => _CorridorPricingScreenState();
}

class _CorridorPricingScreenState extends ConsumerState<CorridorPricingScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('fx.getCorridors');
      if (mounted) {
        setState(() {
