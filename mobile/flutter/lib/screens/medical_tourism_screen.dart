...
class _MedicalTourismScreenState extends State<MedicalTourismScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final data = await apiService.query('medicalTourism.listProviders');
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Medical Tourism', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
          ...
          child: Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search Medical Tourism...',
      ...
      body: _loading
          ...
          : _error != null
              ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('Failed to load Medical Tourism', style: const TextStyle(color: Color(0xFFEF4444))),
                  const SizedBox(height: 12),
              ...
              : _filtered.isEmpty
                  ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      const SizedBox(height: 12),
                      Text(_search.isNotEmpty ? 'No results found.' : 'No Medical Tourism yet.',
