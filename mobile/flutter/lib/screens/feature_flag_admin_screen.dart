...
class FeatureFlagAdminScreen extends ConsumerStatefulWidget {
  const FeatureFlagAdminScreen({super.key});
  @override
  ConsumerState<FeatureFlagAdminScreen> createState() => _FeatureFlagAdminScreenState();
}

class _FeatureFlagAdminScreenState extends ConsumerState<FeatureFlagAdminScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Feature Flag Admin', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
