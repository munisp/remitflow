...
class TransferGoalsScreen extends ConsumerStatefulWidget {
  const TransferGoalsScreen({super.key});
  @override
  ConsumerState<TransferGoalsScreen> createState() => _TransferGoalsScreenState();
}

class _TransferGoalsScreenState extends ConsumerState<TransferGoalsScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('transfers.getGoals');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Transfer Goals', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
