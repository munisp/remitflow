...
class TransferLimitsScreen extends ConsumerStatefulWidget {
  const TransferLimitsScreen({super.key});
  @override
  ConsumerState<TransferLimitsScreen> createState() => _TransferLimitsScreenState();
}

class _TransferLimitsScreenState extends ConsumerState<TransferLimitsScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Transfer Limits', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
