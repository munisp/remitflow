...
class _OnboardingFunnelScreenState extends State<OnboardingFunnelScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final result = await api.get('/onboarding-funnel');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Welcome to RemitFlow'), elevation: 0),
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('Welcome to RemitFlow', style: Theme.of(context).textTheme.headlineSmall),
