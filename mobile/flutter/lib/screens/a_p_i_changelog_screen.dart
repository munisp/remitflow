...
class APIChangelogScreen extends ConsumerStatefulWidget {
  const APIChangelogScreen({super.key});
  @override
  ConsumerState<APIChangelogScreen> createState() => _APIChangelogScreenState();
}

class _APIChangelogScreenState extends ConsumerState<APIChangelogScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/apiChangelog.list');
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            title: Text(
                              item['version']?.toString() ?? item['name']?.toString() ?? 'Item ${index + 1}',
