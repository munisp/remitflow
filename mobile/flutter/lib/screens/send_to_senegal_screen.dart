...
class SendToSenegalScreen extends ConsumerStatefulWidget {
  const SendToSenegalScreen({super.key});
  @override
  ConsumerState<SendToSenegalScreen> createState() => _SendToSenegalScreenState();
}

class _SendToSenegalScreenState extends ConsumerState<SendToSenegalScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Send to Senegal', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
