...
class _FCAComplianceScreenState extends ConsumerState<FCAComplianceScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('compliance.getFCAStatus');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('FCA Compliance', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
