...
class IPLoginHistoryScreen extends ConsumerStatefulWidget {
  const IPLoginHistoryScreen({super.key});
  @override
  ConsumerState<IPLoginHistoryScreen> createState() => _IPLoginHistoryScreenState();
}

class _IPLoginHistoryScreenState extends ConsumerState<IPLoginHistoryScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/ipLoginHistory.list');
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            title: Text(
                              item['ip']?.toString() ?? item['name']?.toString() ?? 'Item ${index + 1}',
