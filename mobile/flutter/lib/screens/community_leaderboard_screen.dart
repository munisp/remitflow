...
class _CommunityLeaderboardScreenState extends ConsumerState<CommunityLeaderboardScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('community.getLeaderboard');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Community Leaderboard', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
