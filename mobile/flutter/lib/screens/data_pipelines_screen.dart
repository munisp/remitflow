...
class DataPipelinesScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DataPipelinesScreen> createState() => _DataPipelinesScreenState();
}
...
class _DataPipelinesScreenState extends ConsumerState<DataPipelinesScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('admin.getDataPipelines');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Data Pipelines', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
