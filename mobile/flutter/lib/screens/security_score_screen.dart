...
class SecurityScoreScreen extends ConsumerStatefulWidget {
  const SecurityScoreScreen({super.key});
  @override
  ConsumerState<SecurityScoreScreen> createState() => _SecurityScoreScreenState();
}

class _SecurityScoreScreenState extends ConsumerState<SecurityScoreScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('security.getScore');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Security Score', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
