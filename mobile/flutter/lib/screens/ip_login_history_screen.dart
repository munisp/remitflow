...
class _IPLoginHistoryScreenState extends ConsumerState<IPLoginHistoryScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('security.getLoginHistory');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('IP Login History', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
