...
class AdminNavAnalyticsScreen extends ConsumerStatefulWidget {
  const AdminNavAnalyticsScreen({super.key});
  @override
  ConsumerState<AdminNavAnalyticsScreen> createState() => _AdminNavAnalyticsScreenState();
}

class _AdminNavAnalyticsScreenState extends ConsumerState<AdminNavAnalyticsScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('admin.getNavAnalytics');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Admin Nav Analytics', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
