...
class AdminComplianceScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdminComplianceScreen> createState() => _AdminComplianceScreenState();
}

class _AdminComplianceScreenState extends ConsumerState<AdminComplianceScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('admin.getComplianceStats');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Admin Compliance', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
