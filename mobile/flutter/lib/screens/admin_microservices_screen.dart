...
class AdminMicroservicesScreen extends ConsumerStatefulWidget {
  const AdminMicroservicesScreen({super.key});
  @override
  ConsumerState<AdminMicroservicesScreen> createState() => _AdminMicroservicesScreenState();
}

class _AdminMicroservicesScreenState extends ConsumerState<AdminMicroservicesScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('admin.getMicroserviceHealth');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Admin Microservices', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
