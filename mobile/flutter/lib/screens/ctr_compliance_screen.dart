...
class _CTRComplianceScreenState extends ConsumerState<CTRComplianceScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('compliance.getCTRReports');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('CTR Compliance', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
