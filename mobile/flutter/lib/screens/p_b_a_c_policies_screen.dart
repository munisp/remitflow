...
class PBACPoliciesScreen extends ConsumerStatefulWidget {
  const PBACPoliciesScreen({super.key});
  @override
  ConsumerState<PBACPoliciesScreen> createState() => _PBACPoliciesScreenState();
}

class _PBACPoliciesScreenState extends ConsumerState<PBACPoliciesScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/pbacPolicies.list');
              ...
              : _items.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.policy, color: const Color(0xFF6C63FF), size: 64),
                          const SizedBox(height: 16),
                          const Text(
                            'No PBAC Policies data yet',
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              ...
                              child: Icon(Icons.policy, color: const Color(0xFF6C63FF), size: 20),
                            ),
                            title: Text(
