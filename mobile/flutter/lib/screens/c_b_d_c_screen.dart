...
class CBDCScreen extends ConsumerStatefulWidget {
  const CBDCScreen({super.key});
  @override
  ConsumerState<CBDCScreen> createState() => _CBDCScreenState();
}

class _CBDCScreenState extends ConsumerState<CBDCScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/cbdc.list');
