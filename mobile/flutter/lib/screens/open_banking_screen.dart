...
class _OpenBankingScreenState extends ConsumerState<OpenBankingScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('openbanking.getAccounts');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Open Banking', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
