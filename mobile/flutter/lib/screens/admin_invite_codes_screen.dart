...
class AdminInviteCodesScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AdminInviteCodesScreen> createState() => _AdminInviteCodesScreenState();
}

class _AdminInviteCodesScreenState extends ConsumerState<AdminInviteCodesScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('admin.getInviteCodes');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Admin Invite Codes', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
