...
class TransferAnalyticsScreen extends ConsumerStatefulWidget {
  const TransferAnalyticsScreen({super.key});
  @override
  ConsumerState<TransferAnalyticsScreen> createState() => _TransferAnalyticsScreenState();
}

class _TransferAnalyticsScreenState extends ConsumerState<TransferAnalyticsScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/transferAnalytics.list');
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          const Text(
                            'No Transfer Analytics data yet',
