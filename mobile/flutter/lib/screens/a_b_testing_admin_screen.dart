...
class ABTestingAdminScreen extends ConsumerStatefulWidget {
  const ABTestingAdminScreen({super.key});
  @override
  ConsumerState<ABTestingAdminScreen> createState() => _ABTestingAdminScreenState();
}

class _ABTestingAdminScreenState extends ConsumerState<ABTestingAdminScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/abTesting.list');
              ...
              : _items.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.science, color: const Color(0xFF6C63FF), size: 64),
                          const SizedBox(height: 16),
                          const Text(
                            'No A/B Testing Admin data yet',
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              ...
                              child: Icon(Icons.science, color: const Color(0xFF6C63FF), size: 20),
                            ),
                            title: Text(
