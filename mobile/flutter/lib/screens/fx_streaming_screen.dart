...
class FXStreamingScreen extends ConsumerStatefulWidget {
  const FXStreamingScreen({super.key});
  @override
  ConsumerState<FXStreamingScreen> createState() => _FXStreamingScreenState();
}

class _FXStreamingScreenState extends ConsumerState<FXStreamingScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('FX Streaming', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
