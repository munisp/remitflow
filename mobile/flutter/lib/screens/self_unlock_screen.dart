...
class SelfUnlockScreen extends StatefulWidget {
  const SelfUnlockScreen({super.key});
  @override
  State<SelfUnlockScreen> createState() => _SelfUnlockScreenState();
}

class _SelfUnlockScreenState extends State<SelfUnlockScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Self Unlock', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
      ...
      body: _loading
          ...
          : _error != null
              ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('Failed to load Self Unlock', style: const TextStyle(color: Color(0xFFEF4444))),
                  const SizedBox(height: 12),
