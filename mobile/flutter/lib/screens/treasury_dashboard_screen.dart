...
class _TreasuryDashboardScreenState extends ConsumerState<TreasuryDashboardScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('treasury.getDashboard');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Treasury Dashboard', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
