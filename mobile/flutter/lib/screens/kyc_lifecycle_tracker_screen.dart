...
class _KYCLifecycleTrackerScreenState extends ConsumerState<KYCLifecycleTrackerScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('kyc.getLifecycle');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('KYC Lifecycle Tracker', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
