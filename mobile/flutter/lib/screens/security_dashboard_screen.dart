...
class _SecurityDashboardScreenState extends ConsumerState<SecurityDashboardScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('security.getDashboard');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Security Dashboard', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
