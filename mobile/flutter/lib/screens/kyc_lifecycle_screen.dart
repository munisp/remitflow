...
class KYCLifecycleScreen extends ConsumerStatefulWidget {
  const KYCLifecycleScreen({super.key});
  @override
  ConsumerState<KYCLifecycleScreen> createState() => _KYCLifecycleScreenState();
}

class _KYCLifecycleScreenState extends ConsumerState<KYCLifecycleScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('KYC Lifecycle', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
