...
class SimilarTransactionsScreen extends ConsumerStatefulWidget {
  const SimilarTransactionsScreen({super.key});
  @override
  ConsumerState<SimilarTransactionsScreen> createState() => _SimilarTransactionsScreenState();
}

class _SimilarTransactionsScreenState extends ConsumerState<SimilarTransactionsScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('transactions.getSimilar');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Similar Transactions', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
