...
class _VAPIDPushManagerScreenState extends ConsumerState<VAPIDPushManagerScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('notifications.getVAPIDStatus');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('VAPID Push Manager', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
