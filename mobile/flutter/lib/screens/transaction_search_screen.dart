...
class _TransactionSearchScreenState extends ConsumerState<TransactionSearchScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('transactions.search');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Transaction Search', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
