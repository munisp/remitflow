...
class TenantAdminScreen extends ConsumerStatefulWidget {
  const TenantAdminScreen({super.key});
  @override
  ConsumerState<TenantAdminScreen> createState() => _TenantAdminScreenState();
}

class _TenantAdminScreenState extends ConsumerState<TenantAdminScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('tenants.list');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Tenant Admin', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
