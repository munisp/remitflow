...
class _PBACPoliciesScreenState extends ConsumerState<PBACPoliciesScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('pbac.getPolicies');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('PBAC Policies', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ...
          : _items.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.policy, size: 64, color: const Color(0xFF64748B)),
