...
class ComplianceMetricsDashboardScreen extends ConsumerStatefulWidget {
  const ComplianceMetricsDashboardScreen({super.key});
  @override
  ConsumerState<ComplianceMetricsDashboardScreen> createState() => _ComplianceMetricsDashboardScreenState();
}

class _ComplianceMetricsDashboardScreenState extends ConsumerState<ComplianceMetricsDashboardScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('compliance.getMetrics');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Compliance Metrics', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
