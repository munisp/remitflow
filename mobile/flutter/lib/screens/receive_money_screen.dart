...
class _ReceiveMoneyScreenState extends ConsumerState<ReceiveMoneyScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('payments.getReceiveDetails');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Receive Money', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
