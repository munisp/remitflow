...
class _GDPRErasureScreenState extends ConsumerState<GDPRErasureScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('privacy.getErasureRequests');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('GDPR Erasure', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
