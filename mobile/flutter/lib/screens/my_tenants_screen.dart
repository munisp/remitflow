...
class MyTenantsScreen extends ConsumerStatefulWidget {
  const MyTenantsScreen({super.key});
  @override
  ConsumerState<MyTenantsScreen> createState() => _MyTenantsScreenState();
}

class _MyTenantsScreenState extends ConsumerState<MyTenantsScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('My Tenants', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
