...
class SystemConfigAdminScreen extends ConsumerStatefulWidget {
  const SystemConfigAdminScreen({super.key});
  @override
  ConsumerState<SystemConfigAdminScreen> createState() => _SystemConfigAdminScreenState();
}

class _SystemConfigAdminScreenState extends ConsumerState<SystemConfigAdminScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('admin.getSystemConfig');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('System Config Admin', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
