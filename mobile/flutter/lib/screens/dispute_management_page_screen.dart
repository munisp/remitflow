...
class DisputeManagementPageScreen extends ConsumerStatefulWidget {
  const DisputeManagementPageScreen({super.key});
  @override
  ConsumerState<DisputeManagementPageScreen> createState() => _DisputeManagementPageScreenState();
}

class _DisputeManagementPageScreenState extends ConsumerState<DisputeManagementPageScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/disputes.list');
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          const Text(
                            'No Dispute Management data yet',
