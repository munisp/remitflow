...
class PromoCodeAdminScreen extends ConsumerStatefulWidget {
  const PromoCodeAdminScreen({super.key});
  @override
  ConsumerState<PromoCodeAdminScreen> createState() => _PromoCodeAdminScreenState();
}

class _PromoCodeAdminScreenState extends ConsumerState<PromoCodeAdminScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Promo Code Admin', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
