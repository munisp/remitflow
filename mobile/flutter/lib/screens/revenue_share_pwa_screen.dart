...
class _RevenueSharePWAScreenState extends ConsumerState<RevenueSharePWAScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('revenueShare.getSummary');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Revenue Share', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ...
          : _items.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.bar_chart, size: 64, color: const Color(0xFF64748B)),
