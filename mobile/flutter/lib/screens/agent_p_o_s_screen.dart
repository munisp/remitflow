...
class AgentPOSScreen extends ConsumerStatefulWidget {
  const AgentPOSScreen({super.key});
  @override
  ConsumerState<AgentPOSScreen> createState() => _AgentPOSScreenState();
}
class _AgentPOSScreenState extends ConsumerState<AgentPOSScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/agentPos.list');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Agent POS', style: TextStyle(color: Color(0xFFE2E8F0), fontWeight: FontWeight.w700)),
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            trailing: Row(
                              ...
                              children: [
                                if (item['amount'] != null)
                                  Text('\$${double.tryParse(item['amount'].toString())?.toStringAsFixed(2) ?? item['amount']}',
                                      style: const TextStyle(color: Color(0xFFE2E8F0), fontWeight: FontWeight.w600)),
