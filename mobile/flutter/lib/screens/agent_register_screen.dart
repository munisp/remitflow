...
class _AgentRegisterScreenState extends State<AgentRegisterScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final data = await apiService.query('agent.listAgents');
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Agent Register', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
          ...
          child: Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search Agent Register...',
      ...
      body: _loading
          ...
          : _error != null
              ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('Failed to load Agent Register', style: const TextStyle(color: Color(0xFFEF4444))),
                  const SizedBox(height: 12),
              ...
              : _filtered.isEmpty
                  ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      const SizedBox(height: 12),
                      Text(_search.isNotEmpty ? 'No results found.' : 'No Agent Register yet.',
