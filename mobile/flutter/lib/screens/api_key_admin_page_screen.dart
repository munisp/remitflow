...
class ApiKeyAdminPageScreen extends ConsumerStatefulWidget {
  const ApiKeyAdminPageScreen({super.key});
  @override
  ConsumerState<ApiKeyAdminPageScreen> createState() => _ApiKeyAdminPageScreenState();
}

class _ApiKeyAdminPageScreenState extends ConsumerState<ApiKeyAdminPageScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/apiKeyAdmin.list');
              ...
              : _items.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.vpn_key, color: const Color(0xFF6C63FF), size: 64),
                          const SizedBox(height: 16),
                          const Text(
                            'No API Key Admin data yet',
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              ...
                              child: Icon(Icons.vpn_key, color: const Color(0xFF6C63FF), size: 20),
                            ),
                            title: Text(
