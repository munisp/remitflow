...
class SWIFTTrackerScreen extends ConsumerStatefulWidget {
  const SWIFTTrackerScreen({super.key});
  @override
  ConsumerState<SWIFTTrackerScreen> createState() => _SWIFTTrackerScreenState();
}

class _SWIFTTrackerScreenState extends ConsumerState<SWIFTTrackerScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('payments.getSWIFTStatus');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('SWIFT Tracker', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
