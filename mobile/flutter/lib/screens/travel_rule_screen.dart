...
class TravelRuleScreen extends ConsumerStatefulWidget {
  const TravelRuleScreen({super.key});
  @override
  ConsumerState<TravelRuleScreen> createState() => _TravelRuleScreenState();
}

class _TravelRuleScreenState extends ConsumerState<TravelRuleScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('compliance.getTravelRule');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Travel Rule', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
