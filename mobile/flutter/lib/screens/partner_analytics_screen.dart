...
class _PartnerAnalyticsScreenState extends ConsumerState<PartnerAnalyticsScreen> {
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('partner.getAnalytics');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Partner Analytics', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
