...
class FXStreamingPageScreen extends ConsumerStatefulWidget {
  const FXStreamingPageScreen({super.key});
  @override
  ConsumerState<FXStreamingPageScreen> createState() => _FXStreamingPageScreenState();
}

class _FXStreamingPageScreenState extends ConsumerState<FXStreamingPageScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/fxStreaming.list');
              ...
              : _items.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.stream, color: const Color(0xFF10B981), size: 64),
                          const SizedBox(height: 16),
                          const Text(
                            'No FX Streaming data yet',
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              ...
                              child: Icon(Icons.stream, color: const Color(0xFF10B981), size: 20),
                            ),
                            title: Text(
