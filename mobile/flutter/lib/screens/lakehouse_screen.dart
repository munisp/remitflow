...
class LakehouseScreen extends ConsumerStatefulWidget {
  const LakehouseScreen({super.key});
  @override
  ConsumerState<LakehouseScreen> createState() => _LakehouseScreenState();
}

class _LakehouseScreenState extends ConsumerState<LakehouseScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Lakehouse', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
