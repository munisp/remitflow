...
class WebhookAdminScreen extends ConsumerStatefulWidget {
  const WebhookAdminScreen({super.key});
  @override
  ConsumerState<WebhookAdminScreen> createState() => _WebhookAdminScreenState();
}

class _WebhookAdminScreenState extends ConsumerState<WebhookAdminScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('webhooks.list');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Webhook Admin', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
