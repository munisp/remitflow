...
class BDCPartnerPortalScreen extends ConsumerStatefulWidget {
  const BDCPartnerPortalScreen({super.key});
  @override
  ConsumerState<BDCPartnerPortalScreen> createState() => _BDCPartnerPortalScreenState();
}
class _BDCPartnerPortalScreenState extends ConsumerState<BDCPartnerPortalScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final result = await api.get('/trpc/bdcPartnerPortal.list');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('BDC Partner Portal', style: TextStyle(color: Color(0xFFE2E8F0), fontWeight: FontWeight.w700)),
