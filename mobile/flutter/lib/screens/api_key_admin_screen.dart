...
class ApiKeyAdminScreen extends ConsumerStatefulWidget {
  const ApiKeyAdminScreen({super.key});
  @override
  ConsumerState<ApiKeyAdminScreen> createState() => _ApiKeyAdminScreenState();
}

class _ApiKeyAdminScreenState extends ConsumerState<ApiKeyAdminScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('api.getAdminKeys');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('API Key Admin', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
