...
class TransferAuditTrailScreen extends ConsumerStatefulWidget {
  const TransferAuditTrailScreen({super.key});
  @override
  ConsumerState<TransferAuditTrailScreen> createState() => _TransferAuditTrailScreenState();
}

class _TransferAuditTrailScreenState extends ConsumerState<TransferAuditTrailScreen> {
  List<dynamic> _items = [];
  bool _loading = true;
  ...
  Future<void> _loadData() async {
    try {
      final result = await apiService.query('audit.getTransferTrail');
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Transfer Audit Trail', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
