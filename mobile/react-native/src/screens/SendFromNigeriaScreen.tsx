...
export default function SendFromNigeriaScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Send from Nigeria</Text>
        <View style={{ width: 50 }} />
      </View>
      ...
      <ScrollView style={styles.content}
        ...
        {isLoading ? (
          ...
          <View style={styles.errorContainer}>
            <Text style={styles.errorText}>Failed to load Send from Nigeria.</Text>
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>{search ? 'No results.' : 'No Send from Nigeria yet.'}</Text>
          </View>
        ) : (
