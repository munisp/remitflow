...
export default function TreasuryManagementScreen() {
  ...
  const { data, isLoading, refetch } = (trpc as any)?.['treasury']?.['getPositions']?.useQuery?.() ?? { data: null, isLoading: false, refetch: () => {} };
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Treasury Management</Text>
