...
export default function FormalizationDashboardScreen() {
  ...
  const { data, isLoading, error, refetch } = trpc.formalization.getDashboard.useQuery(undefined, {
    retry: 2,
    staleTime: 60_000,
  });
      ...
      >
        {isLoading ? (
          ...
          <View style={styles.errorContainer}>
            <Text style={styles.errorText}>Failed to load Formalization Dashboard.</Text>
