...
export default function AdminRevenueShareScreen() {
  ...
  const { data, isLoading, refetch } = (trpc as any)?.['admin']?.['getRevenueShare']?.useQuery?.() ?? { data: null, isLoading: false, refetch: () => {} };
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Admin Revenue Share</Text>
