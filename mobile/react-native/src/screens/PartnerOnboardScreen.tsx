...
export default function PartnerOnboardScreen() {
  ...
  const { data, isLoading, error, refetch } = trpc.partnerApi.listPartners.useQuery(undefined, {
    retry: 2,
    staleTime: 30_000,
  });
      ...
      <ScrollView style={styles.content}
        ...
        {isLoading ? (
          ...
          <View style={styles.errorContainer}>
            <Text style={styles.errorText}>Failed to load Partner Onboarding.</Text>
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>{search ? 'No results.' : 'No Partner Onboarding yet.'}</Text>
          </View>
        ) : (
