...
export default function AdminBulkActionsScreen() {
  ...
  const { data, isLoading, refetch } = (trpc as any)?.['admin']?.['getBulkActions']?.useQuery?.() ?? { data: null, isLoading: false, refetch: () => {} };
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Admin Bulk Actions</Text>
