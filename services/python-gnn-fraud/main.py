...
# _metadata — persisted to PostgreSQL table "gnn_fraud_metadata" (see _db__metadata_* helpers)

class _DbMetadata:
    """PostgreSQL-backed store replacing in-memory dict '_metadata'."""
    TABLE = "gnn_fraud_metadata"
...
def init_pg_tables():
    ...
    try:
        _db_exec("""
            CREATE TABLE IF NOT EXISTS gnn_fraud_metadata (
