...
class StablecoinGateway:
    ...
    def _get_contract(self, stablecoin, network):
    ...
    def get_balance(self, stablecoin, network, address):
    ...
    def transfer(self, stablecoin, network, from_address, to_address, amount, private_key):
    ...
    def approve(self, stablecoin, network, owner_address, spender_address, amount, private_key):
    ...
    def get_allowance(self, stablecoin, network, owner_address, spender_address):
        """
Checks the amount a spender is allowed to withdraw."""
    ...
    def wait_for_receipt(self, tx_hash, network, timeout=120):
    ...
    def get_portfolio_balance(self, address):
