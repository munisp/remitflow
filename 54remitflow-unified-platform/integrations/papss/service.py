...
class TransactionAlreadyExistsError(HTTPException):
    ...
    def __init__(self, detail: str = "Payment transaction with this PAPSS reference ID already exists"):
        super().__init__(status_code=status.HTTP_409_CONFLICT, detail=detail)

class InvalidTransactionStateError(HTTPException):
    """Custom exception for invalid state transitions."""
    def __init__(self, detail: str = "Invalid transaction state transition"):
