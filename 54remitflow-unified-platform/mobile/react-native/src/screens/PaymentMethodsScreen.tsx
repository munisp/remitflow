...
const API_BASE_URL = 'https://api.yourremittanceapp.com/v1';
...
const apiCall = async <T,>(
  ...
  // In a real app, you'd get the auth token here
...
const PaymentMethodsScreen: React.FC = () => {
  ...
  const addPaymentMethod = useCallback(async () => {
    ...
    try {
      ...
      // This is a STUB for tokenization and saving the card on the backend.
      // In a real app, you'd use the gateway's SDK to get a token first.
      const cardData = {
        ...cardInfo.values,
