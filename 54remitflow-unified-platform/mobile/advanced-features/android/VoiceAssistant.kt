package com.remittance.app.voice
...
class GoogleAssistantManager(private val context: Context) {
    ...
    fun handleAssistantIntent(intent: Intent): String? {
        return when (intent.action) {
            "com.remittance.CHECK_BALANCE" -> handleCheckBalance()
            "com.remittance.SEND_MONEY" -> handleSendMoney(intent)
            "com.remittance.VIEW_SPENDING" -> handleViewSpending(intent)
            else -> null
        }
    }
