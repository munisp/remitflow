...
class TigerBeetleCDC:
    ...
    def __init__(self, db_manager, tigerbeetle_client):
        self.db = db_manager
    ...
    async def handle_account_created(self, data: Dict[str, Any]):
    ...
    async def handle_transfer_completed(self, data: Dict[str, Any]):
    ...
    async def handle_balance_updated(self, data: Dict[str, Any]):
