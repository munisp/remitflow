...
# from app.schemas.api_gateway import ApiGatewaySchema
...
class TestApiGatewayService:
    """Unit tests for ApiGateway service."""
    
    def test_create_api_gateway(self, mock_db, sample_data):
        """Test creating a new api_gateway."""
        # Arrange
    ...
    def test_get_api_gateway_by_id(self, mock_db):
        """Test retrieving api_gateway by ID."""
        # Arrange
        entity_id = 1
        # service = ApiGatewayService()
    ...
    def test_update_api_gateway(self, mock_db, sample_data):
        """Test updating an existing api_gateway."""
        # Arrange
        entity_id = 1
    ...
    def test_delete_api_gateway(self, mock_db):
        """Test deleting a api_gateway."""
        # Arrange
        entity_id = 1
        # service = ApiGatewayService()
    ...
    def test_list_api_gateways(self, mock_db):
        """Test listing all api_gateways."""
        # Arrange
        # service = ApiGatewayService()
...
class TestApiGatewayValidation:
    """Tests for ApiGateway validation logic."""
...
class TestApiGatewayIntegration:
    """Integration tests for ApiGateway API endpoints."""
    
    @pytest.mark.asyncio
    async def test_api_create_api_gateway(self, async_client: AsyncClient, sample_data):
        """Test API endpoint for creating api_gateway."""
        # Act
        # response = await async_client.post("/api/api_gateway", json=sample_data)
    ...
    @pytest.mark.asyncio
    async def test_api_get_api_gateway(self, async_client: AsyncClient):
        """Test API endpoint for retrieving api_gateway."""
        # Arrange
        entity_id = 1
        
        # Act
        # response = await async_client.get(f"/api/api_gateway/{entity_id}")
    ...
    @pytest.mark.asyncio
    async def test_api_update_api_gateway(self, async_client: AsyncClient):
        """Test API endpoint for updating api_gateway."""
        # Arrange
        entity_id = 1
        update_data = {"name": "Updated Name"}
        
        # Act
        # response = await async_client.put(f"/api/api_gateway/{entity_id}", json=update_data)
    ...
    @pytest.mark.asyncio
    async def test_api_delete_api_gateway(self, async_client: AsyncClient):
        """Test API endpoint for deleting api_gateway."""
        # Arrange
        entity_id = 1
        
        # Act
        # response = await async_client.delete(f"/api/api_gateway/{entity_id}")
    ...
    async def test_api_authentication_required(self, async_client: AsyncClient):
        ...
        # Act
        # response = await async_client.get("/api/api_gateway")
...
class TestApiGatewayPerformance:
    """Performance tests for ApiGateway."""
