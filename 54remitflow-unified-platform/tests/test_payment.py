...
class TestPaymentService:
    ...
    def test_create_payment(self, mock_db, sample_data):
    ...
    def test_update_payment(self, mock_db, sample_data):
    ...
    def test_delete_payment(self, mock_db):
    ...
    def test_list_payments(self, mock_db):
...
class TestPaymentIntegration:
    ...
    @pytest.mark.asyncio
    async def test_api_create_payment(self, async_client: AsyncClient, sample_data):
        """Test API endpoint for creating payment."""
        # Act
        # response = await async_client.post("/api/payment", json=sample_data)
    ...
    @pytest.mark.asyncio
    async def test_api_get_payment(self, async_client: AsyncClient):
        """Test API endpoint for retrieving payment."""
        # Arrange
        entity_id = 1
        
        # Act
        # response = await async_client.get(f"/api/payment/{entity_id}")
    ...
    @pytest.mark.asyncio
    async def test_api_update_payment(self, async_client: AsyncClient):
        """Test API endpoint for updating payment."""
        # Arrange
        entity_id = 1
        update_data = {"name": "Updated Name"}
        
        # Act
        # response = await async_client.put(f"/api/payment/{entity_id}", json=update_data)
    ...
    @pytest.mark.asyncio
    async def test_api_delete_payment(self, async_client: AsyncClient):
        """Test API endpoint for deleting payment."""
        # Arrange
        entity_id = 1
        
        # Act
        # response = await async_client.delete(f"/api/payment/{entity_id}")
    ...
    async def test_api_authentication_required(self, async_client: AsyncClient):
        ...
        # Act
        # response = await async_client.get("/api/payment")
