"""
Performance and load tests for WalletService
...
class WalletServiceLoadTest(HttpUser):
    """Load test for WalletService using Locust."""
...
class TestWalletServicePerformance:
    """Performance tests for WalletService."""
