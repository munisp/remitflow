...
# from app.schemas.monitoring import MonitoringSchema
...
class TestMonitoringService:
    ...
    def test_create_monitoring(self, mock_db, sample_data):
        """Test creating a new monitoring."""
        # Arrange
    ...
    def test_get_monitoring_by_id(self, mock_db):
        """Test retrieving monitoring by ID."""
        # Arrange
        entity_id = 1
        # service = MonitoringService()
    ...
    def test_update_monitoring(self, mock_db, sample_data):
        """Test updating an existing monitoring."""
        # Arrange
        entity_id = 1
    ...
    def test_delete_monitoring(self, mock_db):
        """Test deleting a monitoring."""
        # Arrange
        entity_id = 1
        # service = MonitoringService()
    ...
    def test_list_monitorings(self, mock_db):
        """Test listing all monitorings."""
        # Arrange
        # service = MonitoringService()
...
class TestMonitoringValidation:
    """Tests for Monitoring validation logic."""
...
class TestMonitoringIntegration:
    ...
    @pytest.mark.asyncio
    async def test_api_create_monitoring(self, async_client: AsyncClient, sample_data):
        """Test API endpoint for creating monitoring."""
        # Act
        # response = await async_client.post("/api/monitoring", json=sample_data)
    ...
    @pytest.mark.asyncio
    async def test_api_get_monitoring(self, async_client: AsyncClient):
        """Test API endpoint for retrieving monitoring."""
        # Arrange
        entity_id = 1
        
        # Act
        # response = await async_client.get(f"/api/monitoring/{entity_id}")
    ...
    @pytest.mark.asyncio
    async def test_api_update_monitoring(self, async_client: AsyncClient):
        """Test API endpoint for updating monitoring."""
        # Arrange
        entity_id = 1
        update_data = {"name": "Updated Name"}
        
        # Act
        # response = await async_client.put(f"/api/monitoring/{entity_id}", json=update_data)
    ...
    @pytest.mark.asyncio
    async def test_api_delete_monitoring(self, async_client: AsyncClient):
        """Test API endpoint for deleting monitoring."""
        # Arrange
        entity_id = 1
        
        # Act
        # response = await async_client.delete(f"/api/monitoring/{entity_id}")
    ...
    async def test_api_authentication_required(self, async_client: AsyncClient):
        ...
        # Act
        # response = await async_client.get("/api/monitoring")
