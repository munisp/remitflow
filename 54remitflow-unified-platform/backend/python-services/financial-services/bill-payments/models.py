"""Database Models for Bill Payment"""
...
class BillPaymentTransaction(Base):
    __tablename__ = "bill_payment_transactions"
    
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    bill_payment_id = Column(String(36), ForeignKey("bill_payment.id"), nullable=False)
    ...
    def to_dict(self):
        return {
            "id": self.id,
            "bill_payment_id": self.bill_payment_id,
