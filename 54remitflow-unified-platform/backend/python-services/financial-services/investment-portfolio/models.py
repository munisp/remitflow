"""Database Models for Investment Portfolio"""
...
class InvestmentPortfolioTransaction(Base):
    ...
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    investment_portfolio_id = Column(String(36), ForeignKey("investment_portfolio.id"), nullable=False)
    ...
    def to_dict(self):
        return {
            "id": self.id,
            "investment_portfolio_id": self.investment_portfolio_id,
