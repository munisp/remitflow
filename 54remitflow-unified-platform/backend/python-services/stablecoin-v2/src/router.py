"""
FastAPI Router for Blockchain Stablecoin Service
...
from .blockchain_stablecoin_service import BlockchainStablecoinService

# Initialize router
router = APIRouter(
    prefix="/api/v1/blockchain-stablecoin",
    tags=["Blockchain Stablecoin"]
)
...
# Initialize service
service = BlockchainStablecoinService()
...
async def health_check():
    ...
    try:
        return BaseResponse(
            success=True,
            message="Blockchain Stablecoin service is healthy"
        )
