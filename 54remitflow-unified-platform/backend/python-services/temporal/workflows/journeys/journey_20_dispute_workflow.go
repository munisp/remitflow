...
// DisputeWorkflow orchestrates the Transaction Dispute journey
func DisputeWorkflow(ctx workflow.Context, input DisputeWorkflowInput) (*DisputeWorkflowResult, error) {
	logger := workflow.GetLogger(ctx)
	logger.Info("DisputeWorkflow started", "user_id", input.UserID)
	...
	result.Message = "Transaction Dispute completed successfully"
	logger.Info("DisputeWorkflow completed", "user_id", input.UserID)
