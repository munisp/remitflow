"""Database Models for White Label"""
...
class WhiteLabelTransaction(Base):
    __tablename__ = "white_label_transactions"
    
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    white_label_id = Column(String(36), ForeignKey("white_label.id"), nullable=False)
