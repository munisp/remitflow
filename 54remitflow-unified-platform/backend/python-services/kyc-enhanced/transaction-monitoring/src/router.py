"""
FastAPI Router for Aml Monitoring Service
...
from .aml_monitoring_service import AmlMonitoringService

# Initialize router
router = APIRouter(
    prefix="/api/v1/aml-monitoring",
    tags=["Aml Monitoring"]
)
...
async def health_check():
    ...
    try:
        return BaseResponse(
            success=True,
            message="Aml Monitoring service is healthy"
        )
