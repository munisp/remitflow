"""
MoneyGram Payment Gateway Implementation
...
class MoneyGramGateway(BasePaymentGateway):
    """
    MoneyGram payment gateway - MoneyGram International Money Transfer
    ...
    def _get_base_url(self) -> str:
        ...
        urls = {
            "production": f"https://api.moneygram.com/v2",
            "sandbox": f"https://sandbox-api.moneygram.com/v2"
        }
