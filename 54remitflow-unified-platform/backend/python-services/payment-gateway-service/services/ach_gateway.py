"""
ACH Payment Gateway Implementation
...
class ACHGateway(BasePaymentGateway):
    """
    ACH payment gateway implementation
    Handles payments through Automated Clearing House
    """
    ...
    def _get_base_url(self) -> str:
        ...
        if self.environment == "production":
            return f"https://api.ach.com/v1"
        return f"https://sandbox-api.ach.com/v1"
