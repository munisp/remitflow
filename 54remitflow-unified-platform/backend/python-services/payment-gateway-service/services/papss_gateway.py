"""
PAPSS Payment Gateway Implementation
...
class PAPSSGateway(BasePaymentGateway):
    """
    PAPSS payment gateway implementation
    Handles payments through Pan-African Payment and Settlement System
    """
    ...
    def _get_base_url(self) -> str:
        ...
        if self.environment == "production":
            return f"https://api.papss.com/v1"
        return f"https://sandbox-api.papss.com/v1"
