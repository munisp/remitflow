"""
WorldRemit Payment Gateway Implementation
...
class WorldRemitGateway(BasePaymentGateway):
    """
    WorldRemit payment gateway - WorldRemit Digital Money Transfer
    ...
    def _get_base_url(self) -> str:
        ...
        urls = {
            "production": f"https://api.worldremit.com/v2",
            "sandbox": f"https://sandbox-api.worldremit.com/v2"
        }
