"""
PromptPay Payment Gateway Implementation
Thailand National e-Payment
"""
...
class PromptPayGateway(BasePaymentGateway):
    """
    PromptPay payment gateway implementation
    Handles payments through Thailand National e-Payment
    """
    ...
    def _get_base_url(self) -> str:
        ...
        if self.environment == "production":
            return f"https://api.promptpay.com/v1"
        return f"https://sandbox-api.promptpay.com/v1"
