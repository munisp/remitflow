"""
WesternUnion Payment Gateway Implementation
...
class WesternUnionGateway(BasePaymentGateway):
    """
    WesternUnion payment gateway - Western Union Money Transfer
    ...
    def _get_base_url(self) -> str:
        ...
        urls = {
            "production": f"https://api.westernunion.com/v2",
            "sandbox": f"https://sandbox-api.westernunion.com/v2"
        }
