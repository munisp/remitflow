...
class CustomException(Exception):
    ...
    def __init__(self, message: str, name: str = "CustomException", status_code: int = status.HTTP_500_INTERNAL_SERVER_ERROR) -> None:
...
class NotFoundException(CustomException):
    ...
    def __init__(self, resource_name: str = "Resource", resource_id: str = None) -> None:
...
class ConflictException(CustomException):
    ...
    def __init__(self, resource_name: str = "Resource", detail: str = None) -> None:
