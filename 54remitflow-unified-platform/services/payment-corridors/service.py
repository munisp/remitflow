...
def _create_nested_fees(db: Session, corridor_id: int, fees: List[schemas.CorridorFeeCreate]):
...
def _create_nested_limits(db: Session, corridor_id: int, limits: List[schemas.CorridorLimitCreate]):
...
def _replace_nested_entities(db: Session, corridor_model: models.PaymentCorridor, data: schemas.PaymentCorridorUpdate):
