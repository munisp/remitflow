...
async def account_not_found_exception_handler(request: Request, exc: AccountNotFound):
...
async def currency_balance_not_found_exception_handler(request: Request, exc: CurrencyBalanceNotFound):
...
async def currency_balance_already_exists_exception_handler(request: Request, exc: CurrencyBalanceAlreadyExists):
