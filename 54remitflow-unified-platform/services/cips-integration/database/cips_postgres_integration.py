...
class CIPSPostgresIntegration:
    ...
    def update_transfer_status(self, transfer_id: str, status: str, cips_status: Optional[str] = None, status_reason: Optional[str] = None):
    ...
    def save_iso20022_message(self, message_data: Dict):
    ...
    def record_compliance_check(self, check_data: Dict):
    ...
    def _log_audit(self, transfer_id: str, action: str, details: Dict):
        """Log audit entry"""
        conn = self._get_connection()
        try:
            cursor = conn.cursor()
    ...
    def update_statistics(self, date: str, currency: str, stats: Dict):
