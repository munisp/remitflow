...
def create_component(component: ComponentCreate, db: Session = Depends(get_db_session)):
    """
...
@handle_service_errors
def update_component(component_id: int, component: ComponentUpdate, db: Session = Depends(get_db_session)):
    """
...
@handle_service_errors
def delete_component(component_id: int, db: Session = Depends(get_db_session)):
    """
...
@handle_service_errors
def read_locations(skip: int = 0, limit: int = 100, db: Session = Depends(get_db_session)):
    """
...
@handle_service_errors
def create_status(status_in: StatusCreate, db: Session = Depends(get_db_session)):
    """
...
@handle_service_errors
def read_statuses(skip: int = 0, limit: int = 100, db: Session = Depends(get_db_session)):
    """
...
@handle_service_errors
def read_status(status_id: int, db: Session = Depends(get_db_session)):
    """
...
@handle_service_errors
def update_status(status_id: int, status_in: StatusUpdate, db: Session = Depends(get_db_session)):
    """
...
@handle_service_errors
def delete_status(status_id: int, db: Session = Depends(get_db_session)):
    """
